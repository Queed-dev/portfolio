    ...
    <header className="w-full min-h-[100vh] flex flex-col md:flex-row items-center justify-between gap-8 py-12">
      {/* Image de profil temporaire */}
        <div className="flex-shrink-0">
            <div className="relative w-80 h-80 md:w-120 rounded-full md:h-120 flex items-end justify-center overflow-hidden">
                <div className="absolute top-10 md:top-30">
                    <Blob1 className=" text-orange-300 fill-current"/>
                </div>
                <Image className={'z-1'} src="/assets/self.png" alt="Photo de Wilky Syndick" width={720} height={720}/>
            </div>
        </div>
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left gap-4">
        <h1 className="bg-gradient-to-r from-orange-400 to-[#033] text-transparent bg-clip-text text-3xl md:text-5xl font-bold bg-">I am Wilky,</h1>
        ...
        <div className="flex gap-4 mt-4">
          <a href="#contact" className="px-6 py-2 rounded-full bg-gradient-to-r from-orange-400 to-[#033] text-white font-semibold hover:bg-green-300 transition">
            Me contacter
          </a>
